...
QT_MOC_LITERAL(1, 15, 15), // "onBtnClickedAdd"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 7) // "checked"

    },
    "PasswordWindow\0onBtnClickedAdd\0\0checked"
};
...
void PasswordWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PasswordWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onBtnClickedAdd((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->onBtnClickedAdd(); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject PasswordWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_PasswordWindow.data,
    qt_meta_data_PasswordWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
